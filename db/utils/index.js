exports.artDateFormat = (articleData, lookupObj) =>
...
exports.makeUserLookup = userData =>
...
exports.makeArticleLookup = articleData =>
  articleData.reduce((acc, article) => {
    acc[article.title] = article.article_id;
    return acc;
  }, {});

exports.formatArticles = (commentData, articleLookup, userLookup) =>
